...
public class Touch {
	...
	public static void main(String[] args) {
		...
		while(true){
			Motor.A.setSpeed((int) (Move.SPEED_MEDIUM * Move.MOTOR_A_CAL_SPEED));
			Motor.B.setSpeed((int) (Move.SPEED_MEDIUM * Move.MOTOR_B_CAL_SPEED));
			...
			if(t2.isPressed()){
				...
				Move.rotateSimultaneDegreeBlocking(-STEP_DEG, Move.SPEED_SLOW);
			}
			if(t3.isPressed()){
