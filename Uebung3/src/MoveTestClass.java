...
public abstract class MoveTestClass {
...
/***************************** Konstruktoren *********************************/
	public MoveTestClass() {
		this.setMotorLeft(Motor.A);
		this.setMotorRight(Motor.A);
	}
	
	public MoveTestClass(NXTRegulatedMotor motorLeft, NXTRegulatedMotor motorRight) {
		this.setMotorLeft(Motor.A);
		this.setMotorRight(Motor.A);
	}
	
	public MoveTestClass(NXTRegulatedMotor motorLeft, NXTRegulatedMotor motorRight, double calDegMotorLeft, double calDegMotorRight, double calSpeedMotorLeft, double calSpeedMotorRight) {
...
/* Zeit in ms, in der die Aktion durchgef�hrt werden soll (abhaengig von super-Klasse */
