...
public class HelloWord {
	...
	public static void rotateDegreeBlocking(int degree, int speed) {
		...
		int deg = (int) (distCirc * 360) / WHEEL_CIRC; // Schneidet ab, statt zu runden
		int driveTime = (int) (distCirc * 360 * 1000)/(speed * WHEEL_CIRC); //leicht ungenau
        ...
        try {
			Thread.sleep(driveTime); //eventuell länger laufen lassen, wegen Zeitabbruch
	...
	public static void moveMilimetersBlocking(int dist, int speed) {
		...
		int driveTime = (dist * 360 * 1000)/(speed * WHEEL_CIRC); //leicht ungenau
