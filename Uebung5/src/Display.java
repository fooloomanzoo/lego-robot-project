...
public class Display {
	...
	public void redraw() {
		...
		// fields
		g.drawChar('x', (int) (cellWidth*1.5 - LCD.FONT_WIDTH/2), (int) (cellHeight*1.5 - LCD.FONT_HEIGHT/2), 0);
		g.drawChar('o', (int) (cellWidth*2.5 - LCD.FONT_WIDTH/2), (int) (cellHeight*1.5 - LCD.FONT_HEIGHT/2), 0);
